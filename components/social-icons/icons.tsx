...
export function StarFull(props: SVGProps<SVGSVGElement>) {
  return (
...
export function StarHalf(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      {/* (선택사항) 오른쪽 빈 부분의 윤곽선을 연하게 보여주고 싶다면 아래 path 추가 */}
      <path d="M12 17.27L18.18 21L16.54 13.97L22 9.24L14.81 8.63L12 2V17.27Z" fillOpacity="0.2" />
    </svg>
  )
}
